...
pub type ToWestendOverBridgeHubLegacyXcmRouterInstance = pallet_xcm_bridge_hub_router::Instance3;
impl pallet_xcm_bridge_hub_router::Config<ToWestendOverBridgeHubLegacyXcmRouterInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = weights::pallet_xcm_bridge_hub_router_to_westend_over_bridge_hub::WeightInfo<Runtime>;
	...
	type ToBridgeHubSender = SovereignPaidRemoteExporter<
		...
		pallet_xcm_bridge_hub_router::impls::ViaRemoteBridgeHubExporter<
			Runtime,
			ToWestendOverBridgeHubLegacyXcmRouterInstance,
...
construct_runtime!(
	pub enum Runtime
	{
		...
		// Bridge utilities.
		ToWestendOverBridgeHubLegacyXcmRouter: pallet_xcm_bridge_hub_router::<Instance3> = 45,
		...
		BridgeWestendMessages: pallet_bridge_messages::<Instance1> = 60,
		BridgeRelayers: pallet_bridge_relayers::<Instance1> = 61,
		XcmOverAssetHubWestend: pallet_xcm_bridge_hub::<Instance1> = 62,
		ToWestendXcmRouter: pallet_xcm_bridge_hub_router::<Instance1> = 63,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		// Bridge pallets
		[pallet_xcm_bridge_hub_router, ToWestendOverBridgeHub]
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			type ToWestendOverBridgeHub = XcmBridgeHubRouterBench<Runtime, ToWestendOverBridgeHubLegacyXcmRouterInstance>;
			type ToWestend = XcmBridgeHubRouterBench<Runtime, bridge_to_westend_config::ToWestendXcmRouterInstance>;
			type OverWestend = pallet_xcm_bridge_hub::benchmarking::Pallet::<Runtime, bridge_to_westend_config::XcmOverAssetHubWestendInstance>;
		...
		fn dispatch_benchmark(
			...
			impl XcmBridgeHubRouterConfig<ToWestendOverBridgeHubLegacyXcmRouterInstance> for Runtime {
			...
			impl XcmBridgeHubRouterConfig<bridge_to_westend_config::ToWestendXcmRouterInstance> for Runtime {
				fn ensure_bridged_target_destination() -> Result<Location, BenchmarkError> {
					Ok(xcm_config::bridging::to_westend::AssetHubWestend::get())
				}
				fn update_bridge_status_origin() -> Option<RuntimeOrigin> {
			...
			impl pallet_xcm_bridge_hub::benchmarking::Config<bridge_to_westend_config::XcmOverAssetHubWestendInstance> for Runtime {
			...
			impl BridgeMessagesConfig<bridge_to_westend_config::WithAssetHubWestendMessagesInstance> for Runtime {
				...
				fn prepare_message_proof(
					...
					let bridge_locations = XcmOverAssetHubWestend::open_bridge_for_benchmarks(
						params.lane,
