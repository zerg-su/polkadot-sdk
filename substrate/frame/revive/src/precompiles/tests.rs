...
fn builtin_matching_works() {
	assert!(<Builtin<Test>>::matches(&hex2array!("0100000000000000000000000000000000000000")));
	assert!(<Builtin<Test>>::matches(&hex2array!("0001000000000000000000000000000000000000")));

	assert!(!<Builtin<Test>>::matches(&hex2array!("0100000000000000000000700000000000000000")));
	assert!(!<Builtin<Test>>::matches(&hex2array!("0001000000000000060000000000000000000000")));
	assert!(!<Builtin<Test>>::matches(&hex2array!("8888888888888888888888888888888888888888")));
}
